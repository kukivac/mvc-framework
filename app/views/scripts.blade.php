...
<script type="text/babel" src="www/scripts/react.js?v={{time}}" async></script>

<!-- Bootstrap -->
<script src="../node_modules/jquery/dist/jquery.slim.js?v={{time}}" defer></script>
<script src="../node_modules/bootstrap/dist/js/bootstrap.js?v={{time}}" defer></script>

<!-- Axios ajax -->
<script src="../node_modules/axios/dist/axios.js?v={{time}}" defer></script>
